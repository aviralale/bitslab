...
export default function UnicodeOutputComponent({
  unicode,
  fontSize,
  copiedField,
  downloadAsFile,
  ...
  const charCount = unicode.length;
  ...
  return (
    <div className="bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800 rounded-none sm:rounded-3xl overflow-hidden">
      ...
      <div className="relative border-b border-neutral-200 dark:border-neutral-800 p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1">
              <Button
                onClick={() => downloadAsFile(unicode, "unicode_output.txt")}
                disabled={!unicode}
                size="icon"
                variant="ghost"
              ...
              <Button
                onClick={() => copyToClipboard(unicode, "unicode")}
                disabled={!unicode}
                size="icon"
                variant="ghost"
                className="h-8 w-8 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-900 disabled:opacity-30"
      ...
      <div className="relative p-4 sm:p-6">
        <div
          className="w-full min-h-64 sm:min-h-80 text-black dark:text-white whitespace-pre-wrap nothing-scrollbar overflow-auto"
          style={{
...
// Compact variant
export function UnicodeOutputCompact({
  unicode,
  fontSize,
  copiedField,
  downloadAsFile,
  ...
  return (
    <div className="border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden">
      ...
      {/* Output area */}
      <div
        className="w-full h-48 p-4 bg-transparent text-black dark:text-white whitespace-pre-wrap nothing-scrollbar overflow-auto"
...
// Minimal variant
export function UnicodeOutputMinimal({
  unicode,
  fontSize,
  copiedField,
  downloadAsFile,
  ...
  return (
    <div className="space-y-2">
      ...
      <div
        className="w-full min-h-64 p-4 border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-transparent text-black dark:text-white whitespace-pre-wrap nothing-scrollbar overflow-auto"
        style={{ fontSize: `${fontSize}px`, lineHeight: 1.6 }}
      >
        {unicode || (
          <span className="text-neutral-400 dark:text-neutral-600">
